Открыть коллекцию элементов и добавить в приложение элемент "Table View Controller"
...
Создать класс для обработки логики действий компонента "Table View Controller" выбрать File -> New -> File -> Cocoa Touch Class
